...
module.exports = {
  class: "ModValidationMultisign",
  proto: ["./proto/modvalidationmultisign.proto"],
  files: ["./ModValidationMultisign.ts"],
  supportAbi1: true,
  sourceDir: "./assembly",
  buildDir: "../build",
  filesImport: [
    {
      dependency: "@veive/mod-validation-as",
      path: "../node_modules/@veive/mod-validation-as/dist/ModValidation.ts",
    }
  ],
  protoImport: [
    {
      name: "@veive/mod-validation-as",
      path: "../node_modules/@veive/mod-validation-as/dist/proto/modvalidation",
    },
    {
